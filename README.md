# 📝 ProPad - Notepad Clone (Python GUI)
...
- **Clean UI:** A simple, distraction-free interface with a scrollbar.
...
- **Concepts:** File Handling (`open`, `read`, `write`), GUI Event Handling.
...
2. Run the script using the terminal:
   ...
   python notepad.py
   ```
The editor window will launch immediately.
